...
/usr/bin/time -v $RUFUSbuild  -c  /uufs/chpc.utah.edu/common/home/marth-d1/home/farrelac/1000gRUFUSreference/1000G.RUFUSreference.sorted.min45.tab -s $ProbandGenerator.Jhash.sorted.min2.tab -o $ProbandGenerator.HashList -hs $K -mS $MutantMinCov -max 300 -t $Threads -d ' ' -mC 0
fi
